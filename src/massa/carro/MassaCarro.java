...
public class MassaCarro {
    public static void main(String[] args) {
        ...
        System.out.print("QualCell a velocidade do segundo corpo (em km/h): ");
        ...
        aceleracaoMediaMs = velocidadeFinal * velocidadeFinal / (2 * distanciaDeformacao);

        System.out.println("aceleracao media em m/s : " + aceleracaoMediaMs);

        aceleracaoMediaKm = aceleracaoMediaMs * 3.6;

        System.out.println("aceleracao media em Km/h : " + aceleracaoMediaKm);
        System.out.println("==========================================");
